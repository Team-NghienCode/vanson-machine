          ...
          <div className='container sm:px-4 lg:px-8 flex flex-wrap items-center justify-between lg:flex-nowrap'>
            ...
            <div
              ...
              <ul className='pl-0 mt-3 mb-2 ml-auto flex flex-col list-none lg:mt-0 lg:mb-0 lg:flex-row'>
                <li>
                  <a className='nav-link page-scroll active' href='/'>
                ...
                <li className='dropdown'>
                  ...
                  <div className='dropdown-menu' aria-labelledby='dropdown01'>
                    <a className='dropdown-item page-scroll' href='/article'>
                      Article Details
                    </a>
                    <div className='dropdown-divider'></div>
                    <a className='dropdown-item page-scroll' href='/terms'>
                      Terms Conditions
                    </a>
                    <div className='dropdown-divider'></div>
                    <a className='dropdown-item page-scroll' href='/privacy'>
                      Privacy Policy
                    </a>
                  </div>
                </li>
        ...
        <div className='footer'>
          <div className='container px-4 sm:px-8'>
            <h4 className='mb-8 lg:max-w-3xl lg:mx-auto'>
              ...
              <a className='text-indigo-600 hover:text-gray-500' href='mailto:email@domain.com'>
                email@domain.com
              </a>
            </h4>
        ...
        <div className='copyright'>
          <div className='container px-4 sm:px-8 lg:grid lg:grid-cols-3'>
            <ul className='mb-4 list-unstyled p-small'>
              <li className='mb-2'>
                <a href='/article'>Article Details</a>
              </li>
              <li className='mb-2'>
