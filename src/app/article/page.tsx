    ...
    <>
      ...
      <div className='ex-basic-1 pt-4'>
        <div className='container px-4 sm:px-8 xl:px-32'>
          ...
          <p className='mb-4'>
            Besides buying the template you need some basic web skills in order to customize it. Nothing too
            fancy HTML/CSS will do just fine and a little bit of image editing. You can always hire a web
            designer to help with the customization work while you provide the template and the content that
            is the most important.
          </p>
          <p className='mb-6'>
            Riga is a landing page HTML template made with Tailwind CSS to help you showcase your mobile app
            online and persuade visitors to download it from the app stores. The author used Tailwind CSS to
            build the template and integrated a nice animated navigation that slides from outside the screen.
          </p>
        </div>
        {/* <!-- end of container --> */}
      </div>
        ...
        <div className='container px-4 sm:px-8 xl:px-32'>
          ...
          <div className='text-box mb-12'>
            ...
            <p className='mb-4'>
              ...
              statistics numbers, image slider for customer logos, dropdown navigation and useful extra pages
              for article details, terms.
            </p>
          </div>
          {/* <!-- end of text-box --> */}
          <p className='mb-6'>
          ...
          <ul className='list-unstyled mb-12 space-y-2'>
            ...
            <li className='flex'>
              <i className='fas fa-square'></i>
              <div className='flex-1 ml-2'>
                <strong>Together with</strong> touches of call to action green, the overall landing page
                design will showcase your app
              </div>
            </li>
            <li className='flex'>
              <i className='fas fa-square'></i>
